...
Imagine you are developing a video game inspired by the popular anime "Konosuba." In this game, players control multiple main characters like Kazuma, Aqua, Darkness, and Megumin. as your game gains more popularity you decide to add new characters and enemies like Yun yun, Eris, Wiz, etc. When you release this new update you start receiving too many tickets from the users saying that the game stop working or it just crashed

When you check the tickets from the users the system show you the possible reasons of the failure, and you identify that all the tickets comes from users that has less than 8gb of ram. 
...
So, now how you can solve this issue, what is the next step to release a new fix to avoid loosing players on your game?
